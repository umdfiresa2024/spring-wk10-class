...
In Week 3's class, each student will work on each step using data from "Defensive Investments and the Impact on Air Quality by Deschenes et al. (2017). In the lab, each student will modify the document to include the dataframe that was developed in FIRE198.
